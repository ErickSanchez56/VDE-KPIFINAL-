...
Public Class FrmImpresionCarritos
    Private Sub FrmImpresionCarritos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ListarImpresora()
    ...
    Private Sub ImprimeEtiquetas()
        Try
            ...
            ws.Url = pUrl
            Cursor.Current = Cursors.WaitCursor
            ' pResultado = ws.WM_ImpContenedor(numEtiquetas.Value, cmbImpresora.Text, "2", DatosTemporales.Usuario)
            Cursor.Current = Cursors.Default
