...
Public Class FrmCreaOrdenEmbarque
    ...
    Private Sub AgregaPartida()
        Try
            ...
            Cursor.Current = Cursors.WaitCursor
            pResultado = pOC.AgregarPartida(txtOrdenCompra.Text, cmbNumParte.Text,
                                            txtCantidad.Text,
    ...
    Public Sub ConsultaOrdenCompra()
        Try
            ...
            Dim pResultado As New CResultado
            Dim pScrap As New COrdenEmbarqueR

            Cursor.Current = Cursors.WaitCursor
            pResultado = pScrap.BuscarOrdenEmbarque(txtOrdenCompra.Text)
            Cursor.Current = Cursors.Default
