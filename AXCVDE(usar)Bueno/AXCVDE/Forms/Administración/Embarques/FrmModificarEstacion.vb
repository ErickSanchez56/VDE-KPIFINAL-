...
Public Class FrmModificarEstacion
    ...
    Private Sub FrmModificaPartidaEstacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            If chkLote Then
    ...
    Private Sub BtnLiberar_Click(sender As Object, e As EventArgs) Handles BtnLiberar.Click
        If chkLote Then
            FrmLiberacionOrdenProduccion.pEstacion = CmbEstacion.Text
            FrmLiberacionOrdenProduccion.pLote = CmbLote.Text
        Else
            FrmLiberacionOrdenProduccion.pEstacion = CmbEstacion.Text
            FrmLiberacionOrdenProduccion.pLote = ""
        End If
