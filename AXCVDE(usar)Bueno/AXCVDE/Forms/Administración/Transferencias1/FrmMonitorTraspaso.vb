...
#Region "EVENTOS"
    Private Sub FrmMonitorOrdenesTras_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            cargarTextoGroup("7")
            cargaOrdenesTras("@", "7", TextEdit1.Text)
            Dia.Tag = 7
...
#Region "METODOS"
    ...
    Public Sub cargaOrdenesTras(ByVal prmBusqueda As String, ByVal prmDias As String, ByVal prmOrden As String)
        ...
        Try
            ...
            Cursor.Current = Cursors.WaitCursor
            pResultado = Cls.ListaOrdenesTrasMontitor(prmDias, My.Settings.Estacion, DatosTemporales.Usuario, pBusqueda)
            Cursor.Current = Cursors.Default
    ...
    Private Sub OnEditValueChanged(ByVal sender As System.Object, ByVal e As EventArgs)
        ...
        cargaOrdenesTras("@", item.Tag, TextEdit1.Text)
    End Sub
    ...
    Private Sub cargarTextoGroup(dias As String)
        Try
    ...
    Private Sub SimpleButton2_Click(sender As Object, e As EventArgs) Handles SimpleButton2.Click
        Pagina = Pagina + 1
        cargaOrdenesTras("@", Dia.Tag, TextEdit1.Text)
        LabelControl1.Text = "Pagina" + "" + Pagina
    End Sub
