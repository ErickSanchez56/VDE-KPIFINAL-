...
Public Class FrmCrearOrdenTraspaso
    ...
    Private Sub btnAgregarNP_Click(sender As Object, e As EventArgs) Handles btnAgregarNP.Click
        Try
            ...
            If cmbAlmacenO.Text = "" Then
                XtraMessageBox.Show("No se ingreso un Almacen Origen", "AXC")
                Return
            End If
            If cmbAlmacenD.Text = "" Then
                XtraMessageBox.Show("No se ingreso un Almacen Destino", "AXC")
                Return
            End If
    ...
    Private Sub AgregaPartida()
        Try
            ...
            Cursor.Current = Cursors.WaitCursor
            pResultado = pOC.AgregarPartida(txtOrdenTras.Text, cmbNumParte.Text,
                                            txtCantidad.Text, cmbAlmacenO.Text, cmbAlmacenD.Text,
    ...
    Public Sub ConsultaTras()
        Try

            grdDetalle.DataSource = Nothing

            If txtOrdenTras.Text = "" Then
                XtraMessageBox.Show("No hay Orden de Traspaso seleccionada", "AXC")
                Return
            End If
    ...
    Private Sub ListaAlmacenes(prmBusqueda As String)
        Try
            Dim pResultado As New CResultado
            Dim Cls As New ClsAlmacen

            Cursor.Current = Cursors.WaitCursor
            pResultado = Cls.ListaAlmacenesPorEstacion(My.Settings.Estacion, DatosTemporales.Usuario)
            Cursor.Current = Cursors.Default
            ...
            cmbAlmacenO.Properties.DataSource = dt
            cmbAlmacenO.Properties.DisplayMember = "Almacen"
            cmbAlmacenO.Properties.ValueMember = "IdAlmacen"
            cmbAlmacenD.Properties.DataSource = dt
            cmbAlmacenD.Properties.DisplayMember = "Almacen"
            cmbAlmacenD.Properties.ValueMember = "IdAlmacen"
    ...
    Private Sub cmbCliente_EditValueChanged(sender As Object, e As EventArgs) Handles cmbAlmacenO.EditValueChanged
        Try
            Dim text As String = cmbAlmacenO.Text
            If text.Equals("System.Data.DataRowView") Then
                Return
            End If
            ListaNumParte(cmbAlmacenO.Text)
        Catch ex As Exception
            XtraMessageBox.Show(ex.Message.ToString, "AXC", MessageBoxButtons.OK)
        End Try
    End Sub
