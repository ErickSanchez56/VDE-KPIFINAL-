...
Public Class FrmOrdenesSurtidoTras
...
#Region "EVENTOS"
    Private Sub FrmOrdenesProdDet_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ListaSurtidos(pOrdenTras)
            lblOrdenCompra.Text = pOrdenTras
    ...
    Private Sub ListaSurtidos(pOrdenProd As String)
        Try
            ...
            If dt.Rows.Count < 1 Then
                ...
                XtraMessageBox.Show("No existen docuementos de surtido con esta orden de Traspaso", "AXC", MessageBoxButtons.OK, MessageBoxIcon.Information)
                dgvConsulta.DataSource = Nothing
                GridView1.Columns.Clear()
                Return
            End If
