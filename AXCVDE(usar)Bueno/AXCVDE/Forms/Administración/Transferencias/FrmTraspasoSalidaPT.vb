...
#Region "METODOS"
    ...
    Sub EstableceEstacion()
        ...
        End If
    End Sub
    Private Sub DgvViewResultado_DoubleClick(sender As Object, e As EventArgs) Handles grdPartidasTraspaso.DoubleClick
        Try
            ...
            pOrdenT = txtTraspasoSalida.Text
            FrmModifcaPartidaEvento.pOrdenProd = pOrdenT
            'FrmModifcaPartidaEvento.pNumParte = pNumParteDet
            'FrmModificaPartida.pLote = pLote
            'FrmModifcaPartidaEvento.pEstacion = pEstacion
            'FrmModificaPartida.chkLote = ChkLote.CheckState
            FrmModifcaPartidaEvento.ShowDialog()
        ...
        Try
            ...
            Else
                If ds.Tables(1).Rows.Count <= 0 Then
                    XtraMessageBox.Show("No se encuentran las partidas de la orden de traspaso")
                    Return
                End If
                ...
                GridView1.Columns("CódigoProveedor").Visible = False

                'GridView1.Columns("CodigoProveedor").Visible = False
