...
Public Class FrmConsultaConsOC

    Public f As FrmLiberaOrdenCompraConsolidacion

    Private Sub FrmConsolidadosOC_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            cmbTipo.EditValue = 0
...
#Region "METODOS"
    Private Sub CargarRecibos(prmBusqueda As String)
        Try
            ...
            pResultado = Cls.CargarRecibos(0, prmBusqueda, dInicio.ToString("yyyyMMdd"), dFin.ToString("yyyyMMdd"), My.Settings.Estacion, DatosTemporales.Usuario)
    ...
    Private Sub DgvViewResultado_DoubleClick(sender As Object, e As EventArgs) Handles DgvViewResultado.DoubleClick
        Try
            ...
            f.pBuscaOC = view.GetRowCellDisplayText(selectedRowHandles(0), view.Columns("CompraCons"))
            Me.Close()
