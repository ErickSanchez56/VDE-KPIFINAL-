...
Public Class ClsKPIF
    ...
    Friend Function DatosCicloRecibo(ByVal prmFecha2 As Date, ByVal prmFecha3 As Date, ByVal prmEstacion As String, ByVal prmUsuario As String) As CResultado
        Dim pRespuesta As New CResultado
        Try
            Dim db As New CAccesoDatos
            Dim pResultado As CResultado
    ...
    Friend Function KPIPresicionSurtidoOrdenes(ByVal prmFechaInicio2 As Date, ByVal prmFechaFin2 As Date, ByVal prmEstacion As String, ByVal prmUsuario As String) As CResultado
        Dim pRespuesta As New CResultado
        Try
            Dim db As New CAccesoDatos
            Dim pResultado As CResultado
            ...
            pResultado = db.SPToDataSet("spQryKPIPresicionSurtidoEmbHistorico", prmFechaInicio, prmFechaFin, prmEstacion, prmUsuario)
